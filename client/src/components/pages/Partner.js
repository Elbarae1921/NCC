                ...
                <div className="box-container partner">
                    ...
                    <div className="box partner">
                        ...
                        <div className="text">
                            ...
                            <p>
                                <pre className="method get">GET</pre> <pre className="url">cnc.org/api/person?firstName=Ben{'&'}familyName=Kenobi{'&'}city=Tatooine</pre>
                            </p>
                            <p style={{marginBottom: "0"}}>
                                <pre className="method post">POST</pre> <pre className="url">curl -H "Authorization: Bearer <key>{'{YOUR_KEY}'}</key>" cnc.org/api/organization/checkin</pre>
                            </p>
                            <p style={{fontSize: "8px", margin: "0"}}>
                                For more information on how to use the API, visit https://cnc.org/api/howto
                            </p>
                        </div>
                    </div>
                </div>
